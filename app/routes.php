...
$app->group('',function () {
    ...
    $this->get('/hopital/{id}/offres', 'OfferController:getList')->setName('hopital.offerslist');

    $this->get('/hopital/offre/{id}', 'OfferController:getOffer')->setName('hopital.viewoffer');
